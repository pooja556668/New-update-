...
"https://i.imgur.com/PqD8g7j.jpeg",
  ...
  var callback = () => api.sendMessage({ body: `👉❤️𝐌𝐚𝐝𝐞 𝐛𝐲 ༄𒁍≛⃝𝐃𝐫.𝐌𝐮𝐬𝐤𝐚𝐧💙✨️`, attachment: fs.createReadStream(__dirname + "/cache/5.jpg") }, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg"));
